...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Console app used by Monash Graduate Education to process high volumes of inbound enquiries across multiple service channels</description>
    ...
    <label>MGE Enquiry Management</label>
    <listPlacement>
