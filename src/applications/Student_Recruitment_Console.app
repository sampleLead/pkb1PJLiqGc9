...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>Useful_links_StudentRecruitment</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>console app used by OFS/Student Recruitment to process high volumes of inbound enquiries across multiple service channels</description>
    ...
    <label>Student Recruitment Console</label>
    <listPlacement>
